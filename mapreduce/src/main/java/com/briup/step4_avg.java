...
public class step4_avg extends Configured implements Tool {
    public static void main(String[] args) throws Exception {
        ToolRunner.run(new step4_avg(),args);
    }
    @Override
    ...
    public static class avgMapper extends Mapper<LongWritable, Text,Text, DoubleWritable>{
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if(split.length==2) {
                context.write(new Text("class9"), new DoubleWritable(Double.valueOf(split[1])));
            }
        }
    }
